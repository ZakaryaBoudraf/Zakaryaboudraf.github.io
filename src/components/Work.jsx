...
const projects = [
  ...
  },
  {
    ...
    desc: "Self-supervised pretraining for epileptic-seizure detection from EEG — bachelor thesis & publication.",
    links: [
  ...
  },
  {
    ...
    img: PFEImg,
    desc: "Desktop database application with full create/read/update/delete operations.",
